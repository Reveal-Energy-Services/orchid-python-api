...
def auto_pick_observations(native_project, native_monitor):
    ...
    pick_attribute_1 = object_factory.CreateAttribute[Double].Create("My Attribute 1", 0.0)
    ...
    pick_attribute_2 = object_factory.CreateAttribute[Double].Create("My Attribute 2")  # Default value is 0.0 (default for `Double` values)

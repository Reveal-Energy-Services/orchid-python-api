...
about_data_frame_columns = [
    ...
    AboutDataFrameColumn('distance_azm', 'DistanceAzimuth', _convert_maybe_value(float)),
    AboutDataFrameColumn('distance_90', 'Distance90', _convert_maybe_value(float)),
    ...
    AboutDataFrameColumn('part_no', 'TreatmentStagePartNumber', _convert_maybe_value(int)),

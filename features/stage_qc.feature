...
Feature: High-level DOM API (user data / stage QC information)
  ...
  Scenario: Change the stage QC information for specific stages
    ...
    When I change the specified stage correction status
      | well    | stage_no | to_correction_status |
      | Demo_1H | 1        | New                  |
      | Demo_2H | 50       | Confirmed            |
      | Demo_2H | 15       | Confirmed            |
      | Demo_1H | 10       | Unconfirmed          |
      | Demo_2H | 21       | Confirmed            |
      | Demo_4H | 3        | Confirmed            |
      | Demo_2H | 12       | Confirmed            |
      | Demo_4H | 31       | Confirmed            |
      | Demo_2H | 20       | Confirmed            |
      | Demo_2H | 38       | Confirmed            |

...
class TestNetQuantity(unittest.TestCase):
    ...
    def test_as_measurement_in_specified_same_unit(self):
        for to_convert_net_quantity, expected, to_unit, tolerance in [
            (net_density_from_lbs_per_cu_ft(40.79), 40.79 * om.registry.lb / om.registry.ft ** 3,
             units.UsOilfield.DENSITY, decimal.Decimal('0.01')),
            (net_density_from_kg_per_cu_m(921.4), 921.4 * om.registry.kg / (om.registry.m ** 3),
            ...
            (net_mass_concentration_from_lbs_per_gal(4.258), 4.258 * om.registry.lb / om.registry.gal,
    ...
    def test_as_measurement_in_specified_different_unit(self):
        for to_convert_net_quantity, expected, to_unit, tolerance in [
            (net_density_from_lbs_per_cu_ft(62.30), 998.0 * om.registry.kg / (om.registry.m ** 3),
             units.Metric.DENSITY, decimal.Decimal('0.2')),
            (net_density_from_kg_per_cu_m(998.0), 62.30 * om.registry.lb / om.registry.ft ** 3,
             units.UsOilfield.DENSITY, decimal.Decimal('0.006')),
            (net_energy_from_ft_lbs(2.024), 2.744 * om.registry.J,
             units.Metric.ENERGY, decimal.Decimal('0.002')),
            (net_energy_from_J(2.744), 2.024 * om.registry.ft_lb,
             units.UsOilfield.ENERGY, decimal.Decimal('7e-4')),
            (net_force_from_lbf(107.8e3), 479.5e3 * om.registry.N,
             units.Metric.FORCE, decimal.Decimal('0.5e3')),
            (net_force_from_N(479.5e3), 107.8e3 * om.registry.lbf,
             units.UsOilfield.FORCE, decimal.Decimal('0.02e3')),
            (net_length_from_ft(155.2), 47.30 * om.registry.m,
             units.Metric.LENGTH, decimal.Decimal('0.04')),
            (net_length_from_m(47.30), 155.2 * om.registry.ft,
             units.UsOilfield.LENGTH, decimal.Decimal('0.03')),
            (net_mass_from_lbs(7987), 3622 * om.registry.kg,
             units.Metric.MASS, decimal.Decimal('0.5e3')),
            (net_mass_from_kg(3.622e3), 7.987e3 * om.registry.lb,
             units.UsOilfield.MASS, decimal.Decimal('2')),
            (net_power_from_hp(9.254), 6901 * om.registry.W,
             units.Metric.POWER, decimal.Decimal('0.8')),
            (net_power_from_W(6901), 9.254 * om.registry.hp,
             units.UsOilfield.POWER, decimal.Decimal('0.002')),
            (net_pressure_from_psi(6972), 48.07e3 * om.registry.kPa,
             units.Metric.PRESSURE, decimal.Decimal('7')),
            (net_pressure_from_kPa(48.07e3), 6972 * om.registry.psi,
             units.UsOilfield.PRESSURE, decimal.Decimal('2')),
            (net_mass_concentration_from_lbs_per_gal(5.017), 601.2 * om.registry.kg / (om.registry.m ** 3),
             units.Metric.PROPPANT_CONCENTRATION, decimal.Decimal('0.2')),
            (net_mass_concentration_from_kg_per_cu_m(601.2), 5.017 * om.registry.lb / om.registry.gal,
             units.UsOilfield.PROPPANT_CONCENTRATION, decimal.Decimal('0.0008')),
            (net_volume_flow_from_oil_bbl_per_min(100.9), 16.04 * (om.registry.m ** 3) / om.registry.min,
             units.Metric.SLURRY_RATE, decimal.Decimal('0.02')),
            (net_volume_flow_from_cu_m_per_min(16.04), 100.9 * om.registry.oil_bbl / om.registry.min,
             units.UsOilfield.SLURRY_RATE, decimal.Decimal('0.1')),
            (net_temperature_from_deg_F(156.2), om.Quantity(69.00, om.registry.degC),
             units.Metric.TEMPERATURE, decimal.Decimal('0.05')),
            (net_temperature_from_deg_C(69.00), om.Quantity(156.2, om.registry.degF),
             units.UsOilfield.TEMPERATURE, decimal.Decimal('0.3')),
            (net_volume_from_oil_bbl(8951), 1423 * om.registry.m ** 3,
             units.Metric.VOLUME, decimal.Decimal('0.2')),
            (net_volume_from_cu_m(1423), 8951 * om.registry.oil_bbl,
    ...
    def test_as_net_quantity(self):
        for to_convert_measurement, physical_quantity, tolerance, expected_net_quantity in [
            (67.07 * om.registry.deg, opq.PhysicalQuantity.ANGLE,
             decimal.Decimal('0.01'), net_angle_from_deg(67.07)),
            (1.414 * om.registry.min, opq.PhysicalQuantity.DURATION,
             decimal.Decimal('0.001'), net_duration_from_min(1.414)),
            (17.17 * om.registry.lb / om.registry.cu_ft, opq.PhysicalQuantity.DENSITY,
             decimal.Decimal('0.01'), net_density_from_lbs_per_cu_ft(17.17)),
    ...
    def test_as_net_quantity_in_different_unit(self):
        for to_convert_measurement, target_unit, tolerance, expected_net_quantity in [
            (2638 * om.registry.kg / (om.registry.m ** 3), units.UsOilfield.DENSITY,
             decimal.Decimal('0.06'), net_density_from_lbs_per_cu_ft(164.7)),
            (164.7 * om.registry.lb / om.registry.cu_ft, units.Metric.DENSITY, decimal.Decimal('2'),
             net_density_from_kg_per_cu_m(2638)),
            (164.7 * om.registry.lb / om.registry.ft ** 3, units.Metric.DENSITY,
             decimal.Decimal('2'), net_density_from_kg_per_cu_m(2638)),
            (53.58e9 * om.registry.ft_lb, units.Metric.ENERGY,
             decimal.Decimal('0.01e9'), net_energy_from_J(72.65e9)),
            (72.65e9 * om.registry.J, units.UsOilfield.ENERGY,
             decimal.Decimal('0.01e9'), net_energy_from_ft_lbs(53.58e9)),
            (507.4e3 * om.registry.N, units.UsOilfield.FORCE,
             decimal.Decimal('0.1e3'), net_force_from_lbf(114.1e3)),
            (114.1e3 * om.registry.lbf, units.Metric.FORCE,
             decimal.Decimal('0.4e3'), net_force_from_N(507.4e3)),
            (43.13 * om.registry.m, units.UsOilfield.LENGTH,
             decimal.Decimal('0.03'), net_length_from_ft(141.51)),
            (141.5 * om.registry.ft, units.Metric.LENGTH,
             decimal.Decimal('0.01'), net_length_from_m(43.13)),
            (4108 * om.registry.lb, units.Metric.MASS,
             decimal.Decimal('1'), net_mass_from_kg(1863)),
            (1863 * om.registry.kg, units.UsOilfield.MASS,
             decimal.Decimal('2'), net_mass_from_lbs(4108)),
            (13.66 * om.registry.hp, units.Metric.POWER,
             decimal.Decimal('0.01e3'), net_power_from_W(10.18e3)),
            (10.18e3 * om.registry.W, units.UsOilfield.POWER,
             decimal.Decimal('0.02'), net_power_from_hp(13.66)),
            (6984 * om.registry.psi, units.Metric.PRESSURE,
             decimal.Decimal('0.01e3'), net_pressure_from_kPa(48.15e3)),
            (48.15e3 * om.registry.kPa, units.UsOilfield.PRESSURE,
             decimal.Decimal('2'), net_pressure_from_psi(6984)),
            (486.4 * om.registry.kg / om.registry.m ** 3, units.UsOilfield.PROPPANT_CONCENTRATION,
             decimal.Decimal('0.001'), net_mass_concentration_from_lbs_per_gal(4.060)),
            (4.060 * om.registry.lb / om.registry.gal, units.Metric.PROPPANT_CONCENTRATION,
             decimal.Decimal('0.2'), net_mass_concentration_from_kg_per_cu_m(486.4)),
            (11.14 * (om.registry.m ** 3) / om.registry.min, units.UsOilfield.SLURRY_RATE,
             decimal.Decimal('0.06'), net_volume_flow_from_oil_bbl_per_min(70.08)),
            (70.08 * om.registry.oil_bbl / om.registry.min, units.Metric.SLURRY_RATE,
             decimal.Decimal('0.01'), net_volume_flow_from_cu_m_per_min(11.14)),
            (om.Quantity(2.004, om.registry.degC), units.UsOilfield.TEMPERATURE,
             decimal.Decimal('0.02'), net_temperature_from_deg_F(35.61)),
            (om.Quantity(35.61, om.registry.degF), units.Metric.TEMPERATURE,
             decimal.Decimal('0.002'), net_temperature_from_deg_C(2.004)),
            (1387 * om.registry.m ** 3, units.UsOilfield.VOLUME,
             decimal.Decimal('7'), net_volume_from_oil_bbl(8722)),
            (8722 * om.registry.oil_bbl, units.Metric.VOLUME,
             decimal.Decimal('1'), net_volume_from_cu_m(1387),),
        ]:
